...
/**
 * Represents a mapping of events for the Logger.
 * This interface defines the structure of events that can be emitted by the Logger.
 */
export interface LoggerEventMap {
  /**
   * Emitted when a log event occurs.
   */
  log: [event: LogEvent];
}
